import { _ as axios, f as isAxiosError, m as mergeConfig$1, p as isCancel, v as __commonJSMin, y as __toESM } from "./axios-BBe5FVqT.js";
import { Bn as markRaw, Ft as onMounted, In as isReactive, Kn as ref, M as Fragment, U as computed, Ut as provide, Wn as reactive, Yn as shallowRef, gn as watch, jt as onBeforeUnmount, nt as defineComponent, o as createSSRApp, pt as h, xt as inject, zt as onUnmounted } from "./vue.runtime.esm-bundler-CJdF6Oq_.js";
...
function useRemember(data, key2) {
	...
	const remembered = type(restored === void 0 ? data : hasCallbacks ? data.__restore(cloneDeep(restored)) : cloneDeep(restored));
...
//#endregion
export { app_default as App, deferred_default as Deferred, form_default as Form, head_default as Head, infiniteScroll_default as InfiniteScroll, link_default as Link, whenVisible_default as WhenVisible, config, createInertiaApp, progress, router, useForm, useFormContext, usePage, usePoll, usePrefetch, useRemember };
